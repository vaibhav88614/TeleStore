            ...
            <div className="p-4 rounded-2xl bg-telegram-hover/20 border border-telegram-border/30 space-y-4">
              ...
              <div className="flex flex-col items-center py-3 space-y-4">
                ...
                <div className="text-center space-y-2.5">
                  <p className="text-xs font-semibold text-telegram-text">Vaibhav</p>

                  <button
                    onClick={(e) => { e.preventDefault(); openUrl('https://github.com/vaibhav88614/TeleStore'); }}
                  ...
                  >
                    ...
                    github.com/vaibhav88614/TeleStore
                  </button>
                </div>
